...
Online teaching is still a new thing for most of us and I am experimenting with different approaches and solutions. We will need to make adjustments to our expectations, be flexible, and make changes as we discover what works and does not work.

The class will be structured around the following elements.

Most of the material for this class will be accessible from the [class web site](https://ericdarve.github.io/me343-cme216-winter-2021/). Meeting information (zoom link) and grades are posted on [Canvas](https://canvas.stanford.edu/courses/131536).
...
To communicate we will post messages using [canvas announcements](https://canvas.stanford.edu/courses/131536/announcements). 
...
- Generative deep networks; this has been a very useful tool in engineering to model stochastic variables. If time allows, we will briefly discuss physics-informed GANs.
